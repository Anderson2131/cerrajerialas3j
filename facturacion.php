...
<head>
    ...
    <title>Generador de Facturas PDF - Cerrajería Las 3J</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        nav.navbar .nav-logo-text {
            color: #fff;
        }
        nav.navbar .nav-logo-text .logo-main {
            font-size: 18px;
            font-weight: 700;
            display: block;
        }
        nav.navbar .nav-logo-text .logo-tagline {
            font-size: 11px;
        ...
        @media (max-width: 768px) {
            nav.navbar ul.nav-menu { display: none; }
            .container { flex-direction: column; }
            .preview-panel { min-width: auto; }
        }
    </style>
</head>
<body>
            ...
            <div class="footer-links-section">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="facturacion.php"><i class="fas fa-file-invoice"></i> Factura</a></li>
